...
public class TaoBaoSpider {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        List<WebElement> elements = driver.findElements(By.xpath(".//ul[@class='items list clearfix']//li[@class=' item clearfix ']"));
        for(WebElement webElement:elements){
            //WebElement webElement1=webElement.findElement(By.xpath();
            System.out.println(webElement.findElement(By.xpath(".//div[@class='title']//a[@class='J_AtpLog']")).getText());
            System.out.println(webElement.findElement(By.xpath(".//div[@class='right-component col-3']//span[@class='g_price']//strong")).getText());
        }
